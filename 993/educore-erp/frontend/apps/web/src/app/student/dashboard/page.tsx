...
export default function StudentDashboard() {
  ...
  return (
    <DashboardShell pageTitle={profile ? `Welcome, ${profile.firstName}` : "My Learning"} requiredRole="STUDENT">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="glass rounded-2xl p-5">
                ...
                <div className="space-y-2">
                  {[
                    ['08:00', 'Mathematics', '→ Room 201'], 
                    ['10:00', 'Physics', '→ Lab 3'], 
                    ['12:00', 'English Literature', '→ Room 105'], 
                    ['02:00', 'Computer Science', '→ Lab 1']
                  ].map(([t, s, r]) => (
